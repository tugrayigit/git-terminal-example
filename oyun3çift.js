    ...
    document.querySelectorAll('.box').forEach(image => {
        ...
        if (image.innerText.length !== 0) {
            if (image.innerText == 'Wpawn' || image.innerText == 'Bpawn') {
                image.innerHTML = `${image.innerText} <img class='allimg allpawn' src="resim/satranc/${image.innerText}.png" alt="">`
                ...
                image.innerHTML = `${image.innerText} <img class='allimg' src="resim/satranc/${image.innerText}.png" alt="">`
                image.style.cursor = 'pointer'
            }
        }
    })
